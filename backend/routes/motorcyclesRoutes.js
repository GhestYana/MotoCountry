...
const {
  ...
  getMotorcycleBrandsController,
  getMotorcycleColorsController
...
router.get('/brands', getMotorcycleBrandsController);
router.get('/colors', getMotorcycleColorsController);
