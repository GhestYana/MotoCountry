...
module.exports.getMotorcycleBrands = async () => {
    const query = `SELECT DISTINCT brand FROM prod_motorcycles WHERE brand IS NOT NULL ORDER BY brand ASC`;
    return db.query(query);
};

module.exports.getMotorcycleColors = async () => {
    const query = `SELECT DISTINCT color FROM prod_motorcycles WHERE color IS NOT NULL ORDER BY color ASC`;
    return db.query(query);
};